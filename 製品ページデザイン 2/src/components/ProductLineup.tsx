    ...
    <section className="py-10 md:py-12 bg-[#f4f6f8]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {data.products.map((product, index) => (
            ...
            >
              ...
              <div className="p-6">
                {/* 製品名 */}
                <h3 className="text-2xl text-center mb-2">{product.name}</h3>
                <div className="text-center text-gray-600 text-sm mb-6">{product.type}</div>
                ...
                <div className="bg-[#f4f6f8] rounded-lg p-4 mb-6">
                  ...
                  <div className="text-sm">{product.recommended}</div>
                </div>
                ...
                {product.price && (
                  <div className="text-center mb-6">
                    ...
                    <div className="text-xs text-gray-500 mt-1">※構成により異なります</div>
                  </div>
                )}
                ...
                <button className={`w-full py-3 rounded-lg transition-all ${
                  product.highlight
                    ...
                    : 'border-2 border-gray-300 hover:border-[#CCFF00] hover:text-[#1A1A1A]'
                }`}>
                  詳細を見る
                </button>
              </div>
        ...
        <div className="text-center mt-10">
          ...
          {data.note && (
            <p className="text-sm text-gray-600 mt-3">{data.note}</p>
          )}
        </div>
      </div>
    </section>
