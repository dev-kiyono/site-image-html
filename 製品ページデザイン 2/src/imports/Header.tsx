...
function Container2() {
  return (
    <div className="h-[40px] relative shrink-0 w-[154.219px]" data-name="Container">
...
export default function Header() {
  return (
    <div className="bg-[#1A1A1A] relative size-full border-b border-[#CCFF00]/20" data-name="Header">
