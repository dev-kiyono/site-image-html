...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* フッター */}
      <footer className="bg-[#1A1A1A] text-white py-12 border-t border-[#CCFF00]/20">
        <div className="max-w-7xl mx-auto px-8 lg:px-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-8">
            ...
            {/* コンタクト情報 */}
            <div>
              <button className="bg-[#1A1A1A] border border-[#CCFF00]/30 text-white px-6 py-2 rounded hover:bg-[#CCFF00] hover:text-[#1A1A1A] transition-colors mb-4 text-sm">
                Contact<br/>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-6">
                  ...
                  <div className="flex gap-3">
                    <a href="#" className="w-8 h-8 bg-[#002040] rounded flex items-center justify-center hover:bg-[#CCFF00] hover:text-[#1A1A1A] transition-colors">
