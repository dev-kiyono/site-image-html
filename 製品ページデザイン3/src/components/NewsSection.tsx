...
export function NewsSection() {
  ...
  const newsItems = [
    ...
    },
    {
      ...
      date: '2024.11.20',
      excerpt: '大手アニメーションスタジオでのワークフロー改善事例特集記事として紹介されています。',
      tag: 'Xsens'
    },
    {
      id: 4,
    ...
    <section className="py-10 md:py-12 bg-[#1A1A1A]">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-8">
          <h2 className="text-white mb-4">最新ニュース</h2>
          <p className="text-[#F4F6F8]">
            製品アップデート情報やイベント出展のお知らせ
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4">
            {newsItems.map((news) => (
              <a
                key={news.id}
                href="#"
                className="block bg-[#002040]/50 border-2 border-[#CCFF00]/20 rounded-lg p-6 hover:border-[#CCFF00] transition-all group"
              >
                <div className="flex flex-col md:flex-row gap-6">
                  {/* 左側：日付とカテゴリー */}
                  <div className="flex-shrink-0 md:w-32">
                    <div className="flex items-center gap-2 text-[#F4F6F8] mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-[#F4F6F8] mb-3">
                      {news.excerpt}
                    </p>
                    {news.tag && (
                  ...
                  <div className="flex-shrink-0 flex items-center">
                    <ChevronRight className="w-6 h-6 text-gray-400 group-hover:text-[#CCFF00] group-hover:translate-x-1 transition-all" />
                  </div>
                </div>
              </a>
            ))}
          ...
          <div className="text-center mt-8">
            <button className="px-8 py-3 border-2 border-gray-300 rounded-lg hover:border-[#CCFF00] hover:text-[#002040] transition-all">
              すべてのニュースを見る
            </button>
          </div>
        </div>
