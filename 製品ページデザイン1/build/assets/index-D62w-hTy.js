...
const heltecLogo = ""+new URL('544c68c7b1766a6fbfcc3dfe317c80e035cd7f3a-B0FHgT7y.png', import.meta.url).href+"";

function Container2() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[40px] relative shrink-0", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heltecLogo, alt: "株式会社HELTEC センシング事業部", className: "h-full w-auto" }) });
}
function Container3() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-stretch flex h-[20px] items-start relative shrink-0 w-full", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-white text-[14px] text-center text-nowrap hover:text-[#CCFF00] transition-colors cursor-pointer", children: "Product" }) });
}
function Container4() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-stretch flex h-[16px] items-start relative shrink-0 w-full", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-['Arimo:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-gray-400 text-[12px] text-center text-nowrap", children: "製品情報" }) });
}
function Link() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[36px] relative shrink-0 w-[48.078px]", "data-name": "Link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container3, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container4, {})
  ] }) });
}
function Container5() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-stretch flex h-[20px] items-start relative shrink-0 w-full", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "basis-0 font-['Arimo:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-white text-[14px] text-center hover:text-[#CCFF00] transition-colors cursor-pointer", children: "Event" }) });
}
function Container6() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-stretch flex h-[16px] items-start relative shrink-0 w-full", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-['Arimo:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-gray-400 text-[12px] text-center text-nowrap", children: "出展情報" }) });
}
function Link1() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[36px] relative shrink-0 w-[48px]", "data-name": "Link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container5, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container6, {})
  ] }) });
}
function Container7() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-stretch flex h-[20px] items-start relative shrink-0 w-full", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "basis-0 font-['Arimo:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px relative shrink-0 text-white text-[14px] text-center hover:text-[#CCFF00] transition-colors cursor-pointer", children: "News" }) });
}
function Container8() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-stretch flex h-[16px] items-start relative shrink-0 w-full", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-['Arimo:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-gray-400 text-[12px] text-center text-nowrap", children: "お知らせ" }) });
}
function Link2() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[36px] relative shrink-0 w-[40.391px]", "data-name": "Link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container7, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container8, {})
  ] }) });
}
function Container9() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-stretch flex h-[20px] items-start relative shrink-0 w-full", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-white text-[14px] text-center text-nowrap hover:text-[#CCFF00] transition-colors cursor-pointer", children: "Company" }) });
}
function Container10() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-stretch flex h-[16px] items-start relative shrink-0 w-full", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "basis-0 font-['Arimo:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal grow leading-[16px] min-h-px min-w-px relative shrink-0 text-gray-400 text-[12px] text-center", children: "会社概要" }) });
}
function Link3() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "basis-0 grow h-[36px] min-h-px min-w-px relative shrink-0", "data-name": "Link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container9, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container10, {})
  ] }) });
}
function Container11() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-stretch flex h-[20px] items-start relative shrink-0 w-full", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-white text-[14px] text-center text-nowrap hover:text-[#CCFF00] transition-colors cursor-pointer", children: "Support" }) });
}
function Container12() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-stretch flex h-[16px] items-start relative shrink-0 w-full", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-['Arimo:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-gray-400 text-[12px] text-center text-nowrap", children: "サポート" }) });
}
function Link4() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[36px] relative shrink-0 w-[49.641px]", "data-name": "Link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container11, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container12, {})
  ] }) });
}
function Navigation() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[36px] relative shrink-0 w-[373.094px]", "data-name": "Navigation", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[32px] items-center relative size-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link1, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link2, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link3, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link4, {})
  ] }) });
}
function Container13() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-stretch flex h-[20px] items-start relative shrink-0 w-full", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-center text-nowrap text-[#1A1A1A]", children: "Contact" }) });
}
function Container14() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-stretch flex h-[16px] items-start relative shrink-0 w-full", "data-name": "Container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-['Arimo:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[12px] text-center text-nowrap text-[#1A1A1A]", children: "お問合せ" }) });
}
function Button() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#CCFF00] hover:bg-[#b8e600] transition-colors h-[56px] relative shrink-0 w-[95.875px] cursor-pointer", "data-name": "Button", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-0 pt-[10px] px-[24px] relative size-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container13, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container14, {})
  ] }) });
}
function Header() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#002040] relative size-full border-b border-[#CCFF00]/20", "data-name": "Header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-row items-center size-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "content-stretch flex items-center justify-between px-[158.5px] py-0 relative size-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container2, {}),
...
const Headphones = createLucideIcon("headphones", __iconNode$7);
...
const heroImage = ""+new URL('6ce8b4fef6346aae1e96521bafe143d68b39ca87-MY43wzwO.png', import.meta.url).href+"";

function NoImage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full bg-gradient-to-br from-[#002040] to-[#1A1A1A] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#CCFF00] text-sm font-bold tracking-wider", children: "NO IMAGE" }) });
}
...
function HeroSection({ content }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative bg-[#002040] text-white overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
      (content?.backgroundImage !== void 0 ? content.backgroundImage : heroImage) && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: content?.backgroundImage !== void 0 ? content.backgroundImage : heroImage,
          alt: "Xsens モーションキャプチャスーツ",
          className: "w-full h-full object-cover opacity-80"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-[#002040]/95 via-[#002040]/50 to-transparent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-[#002040]/60 via-transparent to-transparent" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative container mx-auto px-4 py-12 md:py-16 min-h-[65vh] flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl ml-0 lg:ml-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 h-12 md:h-16 w-32 md:w-40 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NoImage, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-2xl md:text-3xl mb-3 leading-tight text-white", children: [
          "慣性式ハイエンドモーションキャプチャ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl md:text-5xl lg:text-6xl text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]", children: data.titleHighlight })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl lg:text-2xl mb-8 text-white/90", children: data.subtitle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-8 py-4 bg-[#CCFF00] text-[#1A1A1A] hover:bg-[#b8e600] rounded-lg shadow-lg transition-all flex items-center justify-center gap-2 group", children: data.ctaPrimary }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-8 py-4 bg-transparent border-2 border-[#CCFF00] text-[#CCFF00] hover:bg-[#CCFF00] hover:text-[#1A1A1A] rounded-lg transition-all", children: data.ctaSecondary })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row gap-3 text-sm text-white/80 mb-8", children: data.features.map((feature, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-4 h-4 text-[#CCFF00]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: feature })
      ] }, index)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-6 max-w-2xl mb-10", children: data.stats.map((stat, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center sm:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl md:text-5xl mb-2 text-[#CCFF00]", children: stat.value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-white/70", children: stat.label })
      ] }, index)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-white/70 mb-4", children: data.trustBadgeLabel }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-6 items-center", children: data.companies.map((company) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-2 bg-white/5 border border-[#CCFF00]/20 rounded text-sm text-white/80", children: company }, company)) })
      ] })
    ] }) })
  ] });
}
...
function SectionNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      className: `bg-[#002040] border-b border-[#CCFF00]/20 transition-all duration-300 ${isSticky ? "sticky top-[72px] z-30 shadow-md" : ""}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-hide", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 py-2 min-w-max justify-center", children: sections.map((section) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => scrollToSection(section.id),
          className: `px-4 py-2 text-sm whitespace-nowrap rounded transition-all ${activeSection === section.id ? "bg-[#CCFF00] text-[#1A1A1A]" : "text-white hover:bg-white/10"}`,
...
function ProductOverview() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 md:py-12 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block px-4 py-1 bg-[#CCFF00]/20 text-[#1A1A1A] rounded-full text-sm mb-4", children: "Product Overview" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl mb-4 text-[#1A1A1A]", children: "Xsens MVNとは？" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-[#1A1A1A]", children: "外部カメラ不要、身体にセンサーを装着するだけで、高精度なデータ収録を実現する慣性センサ式モーションキャプチャシステムです。" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-12", children: benefits.map((benefit, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center border-2 border-[#f4f6f8] rounded-lg hover:border-[#CCFF00] transition-all hover:shadow-lg overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/3] bg-gradient-to-br from-[#002040] to-[#1A1A1A] flex items-center justify-center overflow-hidden", children: benefit.image ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: benefit.image,
          alt: benefit.title,
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(NoImage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl mb-3 text-[#1A1A1A]", children: benefit.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#1A1A1A]", children: benefit.description })
      ] })
    ] }, index)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 mb-6", children: "まずは無料デモでその性能を体感してください" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-8 py-3 bg-[#CCFF00] text-[#1A1A1A] rounded-lg hover:bg-[#b8e600] transition-all inline-flex items-center gap-2 group", children: "無料デモを予約する" })
    ] })
  ] }) });
}
...
function UseCases({ content }) {
  ...
  const data = content || defaultContent;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 md:py-12 bg-[#1A1A1A]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block px-4 py-1 bg-[#CCFF00] text-[#1A1A1A] rounded-full text-sm mb-4", children: data.badge }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl mb-4 text-white", children: data.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-white/80", children: data.description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto space-y-12 md:space-y-20", children: data.cases.map((useCase, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `flex flex-col ${useCase.reverse ? "md:flex-row-reverse" : "md:flex-row"} gap-8 md:gap-12 items-center`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full md:w-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative aspect-video rounded-xl overflow-hidden bg-[#002040] shadow-2xl border-2 border-[#CCFF00]/20", children: useCase.image ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            ImageWithFallback,
            {
              src: useCase.image,
              alt: useCase.title,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full md:w-1/2 relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-6 left-0 text-[120px] md:text-[150px] opacity-5 select-none pointer-events-none text-[#CCFF00]", children: useCase.number }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl md:text-5xl text-[#CCFF00] mb-4", children: useCase.number }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl md:text-3xl mb-6 text-white", children: useCase.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 leading-relaxed text-lg", children: useCase.description })
            ] })
          ] })
        ]
      },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-8 py-3 bg-[#CCFF00] text-[#1A1A1A] rounded-lg hover:bg-[#b8e600] transition-all inline-flex items-center gap-2 group", children: data.ctaText }) })
  ] }) });
}

function UserVoices({ content }) {
  const defaultContent = {
    badge: "Case Studies",
    title: "導入事例",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-8 md:py-10 bg-gradient-to-br from-[#f4f6f8] to-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block px-4 py-1 bg-[#CCFF00]/20 text-[#1A1A1A] rounded-full text-sm mb-4", children: data.badge }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl mb-4 text-[#1A1A1A]", children: data.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-[#1A1A1A]", children: data.description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: data.voices.map((voice, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          voice.image && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative aspect-[4/3] overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: voice.image,
              alt: voice.company,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-3 py-1 bg-[#002040] text-white text-xs rounded-full mb-3", children: voice.industry }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg mb-2 text-[#1A1A1A] leading-tight", children: voice.company }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 mb-3 leading-relaxed", children: voice.comment })
          ] })
        ]
      },
      index
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-8 py-3 bg-[#CCFF00] text-[#1A1A1A] rounded-lg hover:bg-[#b8e600] transition-all inline-flex items-center gap-2 group", children: data.ctaText }) })
  ] }) });
}

function CompetitiveAdvantage({ content }) {
  const defaultContent = {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 md:py-12 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto mb-12 overflow-x-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-[600px] border-2 border-gray-200 rounded-lg overflow-hidden shadow-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 bg-[#f4f6f8] border-b-2 border-gray-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-r border-gray-200" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-r border-gray-200 text-center bg-[#1A1A1A] text-white", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-1", children: "Xsens" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[#CCFF00]", children: "(慣性式)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-r border-gray-200 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-1 text-[#1A1A1A]", children: "一般的な光学式" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[#1A1A1A]", children: "(マーカー式)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-1 text-[#1A1A1A]", children: "マーカーレス" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[#1A1A1A]", children: "(AI推定)" })
          ] })
        ] }),
        data.comparisonData.map((row, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `grid grid-cols-4 ${index % 2 === 0 ? "bg-white" : "bg-[#f4f6f8]"} border-b border-gray-200 last:border-b-0`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-r border-gray-200", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-1 text-[#1A1A1A]", children: row.feature }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[#1A1A1A]", children: row.note })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-r border-gray-200 flex items-center justify-center bg-[#CCFF00]/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl text-[#1A1A1A]", children: row.xsens }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-r border-gray-200 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl text-[#1A1A1A]", children: row.optical }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl text-[#1A1A1A]", children: row.markerless }) })
            ]
          },
          index
        ))
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center gap-6 mt-6 text-sm text-[#1A1A1A]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "◎" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "優れている" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "○" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "良い" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "△" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "環境による" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto bg-gradient-to-br from-[#f4f6f8] to-white rounded-xl p-8 border-2 border-[#CCFF00]/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl mb-6 text-center text-[#1A1A1A]", children: "Xsensの技術的優位性" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 mb-8", children: data.advantages.map((advantage, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video bg-gradient-to-br from-[#002040] to-[#1A1A1A] rounded-lg mb-4 overflow-hidden", children: advantage.image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: advantage.image, alt: advantage.title, className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(NoImage, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mb-2 text-[#1A1A1A]", children: advantage.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#1A1A1A]", children: advantage.description })
      ] }, index)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center pt-4 border-t border-gray-200", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#1A1A1A] mb-4", children: "あなたのプロジェクトに最適なモデルをご提案します" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-8 py-3 bg-[#CCFF00] text-[#1A1A1A] rounded-lg hover:bg-[#b8e600] transition-all inline-flex items-center gap-2 group", children: data.ctaText })
      ] })
    ] })
  ] }) });
}

function ProductLineup({ content }) {
  const defaultContent = {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 md:py-12 bg-[#1A1A1A]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto", children: data.products.map((product, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `bg-white rounded-xl overflow-hidden transition-all ${product.highlight ? "border-4 border-[#CCFF00] shadow-2xl transform md:-translate-y-4" : "border-2 border-gray-200 shadow-lg hover:border-[#CCFF00] hover:shadow-xl"}`,
        children: [
          product.highlight && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#CCFF00] text-[#1A1A1A] text-center py-2 text-sm", children: "Most Popular" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/3] bg-gradient-to-br from-[#002040] to-[#1A1A1A] flex items-center justify-center overflow-hidden", children: product.image ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: product.image,
              alt: product.name,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl text-center mb-2 text-[#1A1A1A]", children: product.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-[#1A1A1A] text-sm mb-6", children: product.type }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 mb-6", children: product.features.map((feature, fIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-5 h-5 text-[#CCFF00] flex-shrink-0 mt-0.5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-[#1A1A1A]", children: feature })
            ] }, fIndex)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#f4f6f8] rounded-lg p-4 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[#1A1A1A] mb-1", children: "おすすめ用途" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-[#1A1A1A]", children: product.recommended })
            ] }),
            product.price && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl text-[#1A1A1A]", children: product.price }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[#1A1A1A] mt-1", children: "※構成により異なります" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `w-full py-3 rounded-lg transition-all ${product.highlight ? "bg-[#1A1A1A] text-white hover:bg-[#002040]" : "border-2 border-gray-300 text-[#1A1A1A] hover:border-[#CCFF00] hover:text-[#1A1A1A]"}`, children: "詳細を見る" })
          ] })
        ]
      },
      index
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mt-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-8 py-4 bg-[#CCFF00] text-[#1A1A1A] rounded-lg hover:bg-[#b8e600] transition-all inline-flex items-center gap-2 group", children: data.ctaText }),
      data.note && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/70 mt-3", children: data.note })
    ] })
  ] }) });
}
...
function Workflow({ content }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 md:py-12 bg-[#1A1A1A] overflow-visible", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block px-4 py-1 bg-[#CCFF00] text-[#1A1A1A] rounded-full text-sm mb-4", children: data.badge }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl mb-4 text-white", children: data.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-white/80", children: data.description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto mb-12 overflow-visible", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-16 overflow-visible", children: data.steps.map((step, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col overflow-visible", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden flex items-center gap-3 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-[#CCFF00] rounded-full flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#1A1A1A] font-bold text-sm", children: step.number }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-gradient-to-r from-[#CCFF00]/50 to-transparent" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border-2 border-gray-200 rounded-xl overflow-hidden hover:border-[#CCFF00] transition-all hover:shadow-lg flex-1 flex flex-col group relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 left-4 z-10 w-10 h-10 bg-[#CCFF00] rounded-full flex items-center justify-center shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-[#1A1A1A] font-bold", children: step.number }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/3] bg-gradient-to-br from-[#002040] to-[#1A1A1A] flex items-center justify-center overflow-hidden relative", children: step.image ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: step.image,
            alt: step.title,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex-1 flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl mb-2 text-[#1A1A1A]", children: step.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#1A1A1A] mb-3", children: step.description }),
          step.duration && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-block px-3 py-1.5 bg-[#CCFF00]/20 text-[#1A1A1A] rounded-full text-xs self-start", children: [
            "所要時間: ",
            step.duration
          ] })
        ] })
      ] }),
      index < data.steps.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex absolute top-1/2 -right-12 transform -translate-y-1/2 z-30 items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-10 h-10 text-[#CCFF00] drop-shadow-lg", strokeWidth: 2.5 }) }),
      index < data.steps.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden flex justify-center py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-0.5 h-2 bg-[#CCFF00]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-8 h-8 text-[#CCFF00] rotate-90 -mt-1", strokeWidth: 3 })
      ] }) })
    ] }, index)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border-2 border-gray-200 rounded-xl overflow-hidden hover:border-[#CCFF00] transition-all", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video bg-gradient-to-br from-[#002040] to-[#1A1A1A] flex items-center justify-center relative overflow-hidden", children: demoVideo.image ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: demoVideo.image,
          alt: demoVideo.title,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 text-center bg-[#f4f6f8]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg mb-2 text-[#1A1A1A]", children: demoVideo.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#1A1A1A]", children: "実際の操作画面を動画でご確認いただけます" })
      ] })
    ] }) })
  ] }) });
}
...
function Specifications() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-8 md:py-10 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl mb-4 text-[#1A1A1A]", children: "機能・スペック詳細" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-600", children: "技術仕様と詳細情報" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto space-y-4", children: specifications.map((section, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl text-left text-[#1A1A1A]", children: section.title }),
                openSections.includes(index) ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-6 h-6 text-gray-400" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-6 h-6 text-gray-400" })
              ]
            }
          ),
          openSections.includes(index) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-6 border-t border-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4 space-y-3", children: section.items.map((item, itemIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "grid grid-cols-1 md:grid-cols-3 gap-2 py-2 border-b border-gray-100 last:border-b-0",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-[#1A1A1A]", children: item.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-2 text-[#1A1A1A]", children: item.value })
              ]
            },
            itemIndex
          )) }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto mt-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg text-center mb-6 text-[#1A1A1A]", children: "対応ソフトウェア" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center items-center gap-8", children: [
      ...
      ].map((software) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-2 text-xs text-gray-600", children: software.name })
      ] }, software.name)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-8 py-3 bg-[#CCFF00] text-[#1A1A1A] rounded-lg hover:bg-[#CCFF00]/90 transition-colors", children: "詳細スペックシートをダウンロード" }) })
  ] }) });
}
...
function NewsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 md:py-12 bg-[#1A1A1A]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl mb-4 text-white", children: "News" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-white/80", children: "最新情報・お知らせ" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: newsItems.map((news) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: "#",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 md:w-32", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[#1A1A1A] mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-4 h-4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: news.date })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `inline-block px-3 py-1 rounded-full text-xs ${news.categoryColor}`, children: news.category })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl mb-2 text-[#1A1A1A] group-hover:text-[#002040] transition-colors", children: news.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#1A1A1A] mb-3", children: news.excerpt }),
              news.tag && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-[#1A1A1A]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: "w-3 h-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: news.tag })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-6 h-6 text-gray-400 group-hover:text-[#002040] group-hover:translate-x-1 transition-all" }) })
          ] })
        },
        news.id
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-8 py-3 bg-white text-[#1A1A1A] border-2 border-white rounded-lg hover:bg-[#CCFF00] hover:border-[#CCFF00] transition-all", children: "すべてのニュースを見る" }) })
    ] })
  ] }) });
}
...
function Support() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 md:py-12 bg-gradient-to-br from-[#f4f6f8] to-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block px-4 py-1 bg-[#CCFF00]/20 text-[#1A1A1A] rounded-full text-sm mb-4", children: "Support" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl mb-4 text-[#1A1A1A]", children: "サポート体制" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-[#1A1A1A]", children: "導入後も安心。充実のサポート体制で、お客様の成功をバックアップします" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12", children: supportItems.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-white rounded-xl border-2 border-gray-200 hover:border-[#CCFF00] transition-all hover:shadow-lg p-6",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 bg-gradient-to-br from-[#002040] to-[#1A1A1A] rounded-full flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "w-8 h-8 text-[#CCFF00]" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg mb-3 text-[#1A1A1A]", children: item.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#1A1A1A] mb-4", children: item.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: item.details.map((detail, dIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 bg-[#CCFF00] rounded-full mt-1.5 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#1A1A1A]", children: detail })
            ] }, dIndex)) })
          ] })
        ]
      },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto mt-12 bg-[#002040] text-white rounded-xl p-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl mb-4", children: "導入前のご相談も承ります" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mb-6", children: [
        "「どのモデルを選べばいいかわからない」「自社の環境で使えるか不安」など、",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        "導入前の疑問や不安も、お気軽にご相談ください。"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-8 py-3 bg-[#CCFF00] text-[#1A1A1A] rounded-lg hover:bg-[#CCFF00]/90 transition-colors", children: "お問い合わせフォーム" })
    ] })
  ] }) });
}
...
function BlogSection({ content }) {
  ...
  const data = content || defaultContent;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 md:py-12 bg-[#1A1A1A]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block px-4 py-1 bg-[#CCFF00] text-[#1A1A1A] rounded-full text-sm mb-4", children: data.badge }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl mb-2 text-white", children: data.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80", children: data.description })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "hidden md:inline-flex items-center gap-2 px-6 py-3 bg-white text-[#1A1A1A] border-2 border-white rounded-lg hover:bg-[#CCFF00] hover:border-[#CCFF00] transition-all whitespace-nowrap", children: data.ctaText })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: data.posts.map((post, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "group cursor-pointer",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-video bg-gray-200 rounded-lg mb-4 overflow-hidden relative", children: [
            post.image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: post.image, alt: post.title, className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(NoImage, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-1 bg-white rounded-full text-xs text-[#1A1A1A]", children: post.category }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 flex items-center gap-3 text-sm text-white/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: post.date }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl mb-2 text-white group-hover:text-[#CCFF00] transition-colors", children: post.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/70 mb-3 line-clamp-2", children: post.excerpt })
        ]
      },
      index
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-8 md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-6 py-3 bg-white text-[#1A1A1A] border-2 border-white rounded-lg hover:bg-[#CCFF00] hover:border-[#CCFF00] transition-all w-full", children: data.ctaText }) })
  ] }) }) });
}

function FAQ({ content }) {
  const [openItems, setOpenItems] = reactExports.useState([0]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 md:py-12 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block px-4 py-1 bg-[#CCFF00]/20 text-[#1A1A1A] rounded-full text-sm mb-4", children: data.badge }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl mb-4 text-[#1A1A1A]", children: data.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-600", children: data.description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto space-y-4", children: data.faqs.map((faq, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
            ...
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 flex-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-8 h-8 bg-[#CCFF00] text-[#1A1A1A] rounded-full flex items-center justify-center text-sm mt-0.5", children: "Q" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg pr-4 text-[#1A1A1A]", children: faq.question })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: openItems.includes(index) ? /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "w-6 h-6 text-[#1A1A1A]" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-6 h-6 text-gray-400" }) })
              ]
            }
          ),
          openItems.includes(index) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-5 border-t border-gray-200 bg-[#f4f6f8]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 pt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-8 h-8 bg-[#002040] text-[#CCFF00] rounded-full flex items-center justify-center text-sm", children: "A" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#1A1A1A] leading-relaxed flex-1", children: faq.answer })
          ] }) })
        ]
      },
      index
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto mt-12 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 mb-6", children: data.ctaDescription }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-8 py-3 bg-[#CCFF00] text-[#1A1A1A] rounded-lg hover:bg-[#b8e600] transition-all inline-flex items-center gap-2 group", children: data.ctaText })
    ] })
  ] }) });
}
...
function RelatedProducts({ content }) {
  ...
  const data = content || defaultContent;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 md:py-12 bg-[#1A1A1A]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block px-4 py-1 bg-[#CCFF00] text-[#1A1A1A] rounded-full text-sm mb-4", children: data.badge }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl mb-2 text-white", children: data.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-white/80", children: data.description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: data.products.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square bg-gradient-to-br from-gray-100 to-gray-200 relative", children: product.image ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: product.image,
              alt: product.name,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[#1A1A1A] mb-2", children: product.category }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg mb-3 text-[#1A1A1A] group-hover:text-[#002040] transition-colors", children: product.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#1A1A1A] mb-4 leading-relaxed", children: product.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center text-[#002040] transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "詳細を見る" }) })
          ] })
        ]
      },
      product.id
...
function FooterCTA({ content }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 md:py-12 bg-[#002040] text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl mb-4 text-white", children: data.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-white/80", children: data.description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row gap-4 justify-center items-center", children: data.actions.map((action, index) => {
      const Icon = getIcon(action.icon);
      const isPrimary = action.type === "primary";
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          className: `flex items-center justify-center gap-3 px-8 py-5 rounded-xl transition-all text-lg group ${isPrimary ? "bg-[#CCFF00] text-[#1A1A1A] hover:bg-[#b8e600]" : getButtonClasses(action.type)}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-6 h-6 group-hover:scale-110 transition-transform" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: action.text })
          ]
        },
        index
      );
    }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/70", children: "※ 営業時間：平日 9:00〜18:00（土日祝除く）" }) })
  ] }) });
}

function StickyButton({ content }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-6 right-6 z-50 animate-fadeIn", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "flex items-center gap-3 px-6 py-4 bg-[#CCFF00] text-[#1A1A1A] rounded-full shadow-2xl hover:bg-[#b8e600] hover:scale-105 transition-all group", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-5 h-5 group-hover:scale-110 transition-transform" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: data.text })
  ] }) });
}
...
const emptyCompetitiveAdvantage = {
  badge: "比較バッジ",
  title: "競合比較タイトル",
...
function AppEmpty() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#1A1A1A]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 h-[72px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSection, { content: emptyHeroContent }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionNav, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "overview", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductOverview, { content: emptyProductOverview }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "use-cases", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UseCases, { content: emptyUseCases }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "competitive", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CompetitiveAdvantage, { content: emptyCompetitiveAdvantage }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "lineup", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductLineup, { content: emptyProductLineup }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "user-voices", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserVoices, { content: emptyUserVoices }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "workflow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Workflow, { content: emptyWorkflow }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "specs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Specifications, { content: emptySpecifications }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "news", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NewsSection, { content: emptyNews }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "support", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Support, { content: emptySupport }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "blog", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BlogSection, { content: emptyBlog }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "faq", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FAQ, { content: emptyFAQ }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "related", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RelatedProducts, { content: emptyRelatedProducts }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FooterCTA, { content: emptyFooterCTA })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-[#002040] text-white py-12 border-t border-[#CCFF00]/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-8 lg:px-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-12 mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#CCFF00] rounded w-10 h-10" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white", children: "株式会社HELTEC" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-sm", children: "センシング事業部" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-white/70 space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white mb-2", children: "Address" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "〒135-0047" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "東京都江東区門前仲町19-11" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Tokyo Monmaka Village 6F" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "bg-[#002040] border border-[#CCFF00]/30 text-white px-6 py-2 rounded hover:bg-[#CCFF00] hover:text-[#1A1A1A] transition-colors mb-4 text-sm", children: [
            "Contact",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "お問合せ" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-white/70 space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white mb-1", children: "Product" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-xs", children: "製品情報" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white mb-1", children: "Event" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-xs", children: "出展情報" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white mb-1", children: "News" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-xs", children: "お知らせ" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white mb-1", children: "Company" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-xs", children: "会社概要" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white mb-1", children: "Support" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-xs", children: "サポート" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white mb-1", children: "Privacy Policy" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-xs", children: "個人情報保護方針" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white mb-2", children: "Follow us" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-xs mb-2", children: "ブログ" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "w-8 h-8 bg-white/10 rounded flex items-center justify-center hover:bg-[#CCFF00] hover:text-[#1A1A1A] transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "f" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "w-8 h-8 bg-white/10 rounded flex items-center justify-center hover:bg-[#CCFF00] hover:text-[#1A1A1A] transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "▶" }) })
            ] })
          ] })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-[#CCFF00]/20 pt-6 text-center text-sm text-white/70", children: "©2024 HELTEC All Rights Reserved" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StickyButton, {})
  ] });
}

clientExports.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsxRuntimeExports.jsx(AppEmpty, {}));
