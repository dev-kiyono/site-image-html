    ...
    <section className="py-8 md:py-10 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-8">
          <h2 className="text-3xl md:text-4xl mb-4 text-[#1A1A1A]">機能・スペック詳細</h2>
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          {specifications.map((section, index) => (
            ...
            >
              ...
              >
                <h3 className="text-xl text-left text-[#1A1A1A]">{section.title}</h3>
                  ...
                  <div className="pt-4 space-y-3">
                    {section.items.map((item, itemIndex) => (
                      ...
                      >
                        ...
                        <div className="md:col-span-2 text-[#1A1A1A]">{item.value}</div>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto mt-12">
          <h3 className="text-lg text-center mb-6 text-[#1A1A1A]">対応ソフトウェア</h3>
          <div className="flex flex-wrap justify-center items-center gap-8">
            {[
              ...
              <div key={software.name} className="flex flex-col items-center">
                ...
                <span className="mt-2 text-xs text-gray-600">{software.name}</span>
              </div>
            ))}
          </div>
        </div>
