    ...
    <section className="py-10 md:py-12 bg-gradient-to-br from-[#f4f6f8] to-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-10">
          ...
          <h2 className="text-3xl md:text-4xl mb-4 text-[#1A1A1A]">サポート体制</h2>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {supportItems.map((item, index) => (
            ...
            >
              ...
              <div>
                {/* タイトル */}
                <h3 className="text-lg mb-3 text-[#1A1A1A]">{item.title}</h3>

                {/* 説明 */}
                <p className="text-sm text-[#1A1A1A] mb-4">{item.description}</p>
