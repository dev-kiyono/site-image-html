    ...
    <section className="py-10 md:py-12 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-10">
          ...
          <h2 className="text-3xl md:text-4xl mb-4 text-[#1A1A1A]">
            {data.title}
          </h2>
        ...
        <div className="max-w-5xl mx-auto mb-12 overflow-x-auto">
          <div className="min-w-[600px] border-2 border-gray-200 rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="grid grid-cols-4 bg-[#f4f6f8] border-b-2 border-gray-200">
              ...
              <div className="p-4 border-r border-gray-200 text-center">
                <div className="mb-1 text-[#1A1A1A]">一般的な光学式</div>
                <div className="text-xs text-[#1A1A1A]">(マーカー式)</div>
              </div>
              <div className="p-4 text-center">
                <div className="mb-1 text-[#1A1A1A]">マーカーレス</div>
                <div className="text-xs text-[#1A1A1A]">(AI推定)</div>
              </div>
            </div>
            ...
            {data.comparisonData.map((row, index) => (
              <div
                key={index}
                className={`grid grid-cols-4 ${index % 2 === 0 ? 'bg-white' : 'bg-[#f4f6f8]'
                  } border-b border-gray-200 last:border-b-0`}
              >
                <div className="p-4 border-r border-gray-200">
                  <div className="mb-1 text-[#1A1A1A]">{row.feature}</div>
                  <div className="text-xs text-[#1A1A1A]">{row.note}</div>
                </div>
                <div className="p-4 border-r border-gray-200 flex items-center justify-center bg-[#CCFF00]/10">
                  <div className="text-2xl text-[#1A1A1A]">{row.xsens}</div>
                </div>
                <div className="p-4 border-r border-gray-200 flex items-center justify-center">
                  <div className="text-2xl text-[#1A1A1A]">{row.optical}</div>
                </div>
                <div className="p-4 flex items-center justify-center">
                  <div className="text-2xl text-[#1A1A1A]">{row.markerless}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          {/* 凡例 */}
          <div className="flex justify-center gap-6 mt-6 text-sm text-[#1A1A1A]">
        ...
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#f4f6f8] to-white rounded-xl p-8 border-2 border-[#CCFF00]/20">
          <h3 className="text-2xl mb-6 text-center text-[#1A1A1A]">Xsensの技術的優位性</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            {data.advantages.map((advantage, index) => (
              <div key={index}>
                ...
                <h4 className="mb-2 text-[#1A1A1A]">{advantage.title}</h4>
          ...
          <div className="text-center pt-4 border-t border-gray-200">
            <p className="text-[#1A1A1A] mb-4">あなたのプロジェクトに最適なモデルをご提案します</p>
